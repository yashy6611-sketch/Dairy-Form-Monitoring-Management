  ...
  <body>
    ...
    <div id="id01" class="modal">
      ...
      <h3>  <b> <u> Add new farmer</u></b> </h3>
        <div class="container">
		<label for="name">Farmer ID <sup>*</sup> </label>
                <input type="text" name="id" value="" placeholder="enter name of farmer ID" required/>
                <br>
                <label for="name">First Name <sup>*</sup> </label>
                <input type="text" name="fname" value="" placeholder="enter name of farmer" required/>
                <br>
                <label for="ph">Phone number<sup>*</sup> </label>
                <input type="text" name="ph" value="" placeholder="Phone Number" maxlength="14" required/>
                <br>
                ...
                <input type="text" name="animalID" value="" placeholder="Issued by Health Ministry" maxlength="10" required/>
                <br>		
    ...
    <?php
      ...
      <thead>
        <tr>
		  ...
		  <th scope="col"><i class="fas fa-id-badge"></i> Animal</th>
